...
@MPSLaunch
public class DeleteLineStatementInHorizontalCollection_Test extends BaseTransformationTest {
  @Test
  public void test_DeleteLineStatementInHorizontalCollection() throws Throwable {
    initTest("${mps_home}", "r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest@tests)");
    runTest("jetbrains.mps.editorTest.DeleteLineStatementInHorizontalCollection_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      initEditorComponent("6739703022154335181", "6739703022154335194");
