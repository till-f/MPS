...
@MPSLaunch
public class DeleteLineNestedSingleChild_Test extends BaseTransformationTest {
  @Test
  public void test_DeleteLineNestedSingleChild() throws Throwable {
    initTest("${mps_home}", "r:c44f4b8c-137c-4225-8bd9-38d232a9b736(jetbrains.mps.lang.editor.actions.test)");
    runTest("jetbrains.mps.lang.editor.actions.test.DeleteLineNestedSingleChild_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      initEditorComponent("7814731350146768759", "7814731350146951895");
